...
class BusStationsPage extends StatefulWidget {
  ...
  @override
  State<BusStationsPage> createState() =>
      _BusStationsPageState(selectedBusNumbers: selectedBusNumbers);
}
          ...
          child: Column(children: [
            Container(
              ...
              decoration: const BoxDecoration(color: Colors.white, boxShadow: [
                BoxShadow(
                    color: Color.fromRGBO(0, 0, 0, .15), offset: Offset(0, 0.4))
              ]),
              child: TextButton(
                  onPressed: () {
            ...
            Container(
                ...
                child: Row(children: [
                  const Icon(Ionicons.bus_outline,
                      size: 24, color: Color.fromRGBO(0, 0, 0, .8)),
                  ...
                  ...Iterable<int>.generate(selectedBusNumbers.length).map(
                      (int index) => Flexible(
                          child: Container(
                              ...
                              child: Text(selectedBusNumbers[index].number,
                ...
                child: const Row(
                    ...
                    children: [
                      Icon(Ionicons.swap_vertical_outline,
                          size: 21, color: Color.fromRGBO(41, 86, 154, 1)),
                      SizedBox(width: 5),
                      Text(
                        "Change direction",
                        style: TextStyle(
                ...
                for (int i = 0; i < busStations.length; i++)
                  Container(
                      margin: EdgeInsets.only(
                          left: selectedStation == i ? 13 : 17, right: 20),
                      child: Row(children: [
                        Container(
                          alignment: Alignment.center,
                          ...
                          decoration: BoxDecoration(
                              borderRadius: selectedStation == i
                                  ? const BorderRadius.all(Radius.circular(11))
                                  : const BorderRadius.all(Radius.circular(7)),
                              color: selectedStation != i
                                  ? const Color.fromARGB(255, 45, 45, 45)
                                  : const Color.fromRGBO(255, 255, 255, 1),
                              border: selectedStation == i
                                  ? Border.all(
                                      color:
                                          const Color.fromRGBO(41, 86, 154, 1))
                                  : null),
                          child: selectedStation == i
                              ? Container(
                                  width: 13,
                                  height: 13,
                                  decoration: const BoxDecoration(
                  ...
                  onPressed: selectedStation != null
                      ? () => {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => NotifyingPage(
                                        selectedBusNumbers: selectedBusNumbers,
                                        busStations: busStations.sublist(0, selectedStation + 1))))
                          }
                      : null,
                  style: TextButton.styleFrom(
                    backgroundColor: selectedStation != null
                        ? const Color.fromRGBO(41, 86, 154, 1)

...
class NotifyingPage extends StatefulWidget {
  ...
  const NotifyingPage({super.key, required this.selectedBusNumbers, required this.busStations});

  @override
  State<NotifyingPage> createState() => _NotifyingPageState(selectedBusNumbers: selectedBusNumbers, busStations: busStations);
...
class _NotifyingPageState extends State<NotifyingPage> {
  ...
  _NotifyingPageState({required this.selectedBusNumbers, required this.busStations});
        ...
        children: [
          ...
          AnimatedPadding(
            ...
            child: const Align(
              ...
              child: Image(
                image: AssetImage('assets/icons/location.gif'), 
                width: 90
              )
            ),
          ),
                          ...
                          child: TextButton(
                            onPressed: () => {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PwdOnWayPage(selectedBusNumbers: selectedBusNumbers, busStations: busStations)
                                )
                              )
                            },

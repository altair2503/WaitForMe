                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            try {
                              ...
                              // await AuthService.firebase()
                              //     .createUser(name: name,surename : surename, email: email, password: password, role: "driver");
                              ...
                              await showErrorDialog(
                                  context, 'UserPermissionDeniedException');
                            } on QuotaExceededException {
                               await showErrorDialog(
                                  context, 'QuotaExceededException');
                            } on GenericFirestoreException {
                              await showErrorDialog(
                                  context, 'GenericFirestoreException');
